...
{
	//wstring wst = L"{\"userId\": \"";
	//wst.append(user->UserId);
	//wst.append(L"\",");
	//wst.append(L"\"userNickName\" : \"");
	//wst.append(user->UserNickName);
	//wst.append(L"\",");
	//wst.append(L"\"userNumber\" : \"");
	//wst.append(user->UserNumber);
	//wst.append(L"\",");
	//wst.append(L"\"userRemark\" : \"");
	//wst.append(user->UserRemark);
	//wst.append(L"\"}");

	////发送信息到服务器
	//sendMessageBySocket(wst.data());
}
